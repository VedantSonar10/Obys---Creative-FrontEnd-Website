...
function sheryAnimation() {
    ...
    Shery.makeMagnet("#nav h4,#nav svg:nth-child(1),.circle-div,.element,.menu-opener__square, .box>h5", {
        ease: "easeInOutElastic", // Changed easing function for a more dramatic effect
        duration: 1, // Increased duration for a slower animation
        scale: 1.2, // Assuming Shery.makeMagnet supports scale, add slight scaling effect
        rotation: 15, // Assuming rotation is supported, add a slight rotation
        delay: 0.1 // Add a slight delay before the animation starts
    });
